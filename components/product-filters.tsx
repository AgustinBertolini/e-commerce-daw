...
export default function ProductFilters({ maxPrice = 1000, onFiltersChange, initialFilters = {} }: ProductFiltersProps) {
  const [filters, setFilters] = useState<ProductFilters>({
    categories: initialFilters.categories || [],
    priceRange: initialFilters.priceRange || [0, maxPrice],
    genders: initialFilters.genders || [],
    inStock: initialFilters.inStock === undefined ? null : initialFilters.inStock,
  })
  ...
  const handleGenderChange = (genderId: string, checked: boolean) => {
    setFilters((prev) => ({
      ...prev,
      genders: checked ? [...prev.genders, genderId] : prev.genders.filter((id) => id !== genderId),
    }))
  }
  ...
  const handleStockChange = (stockOption: string, checked: boolean) => {
    ...
    setFilters((prev) => ({
      ...prev,
      inStock: stockOption === "in-stock" ? true : stockOption === "out-of-stock" ? false : null,
    }))
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <Accordion type="multiple" defaultValue={["category", "price", "gender", "availability"]}>
              ...
              {genders.map((gender) => (
                <div key={gender.id} className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleGenderChange(gender.id, checked === true)}
                  />
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleStockChange("in-stock", checked === true)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleStockChange("all-stock", checked === true)}
                />
